                            ...
                            <label class="label">Vendedor</label>
                                <div class="control">
                                  <div class="select">
                                    ...
                                    <?php
                                       $query = "SELECT * FROM rh WHERE departamento = 'ventas'";
                                       $result_rh = mysqli_query($conn, $query);
                                       while($row = mysqli_fetch_array($result_rh)){ ?>
                                      
                                      <option><?php echo $row["id_empleado"] ?>  -  <?php echo $row["nombres"] ?></option>
                                ...
                                <div class="control">
                                  <div class="select">
                                    ...
                                    <?php
                                      ...
                                      <option><?php echo $row["id"] ?> - <?php echo $row["nombre"] ?> - <?php echo $row["modelo"]?> - $<?php echo $row["precio"] ?></option>
